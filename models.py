...
class Product(db.Model):
    ...
    show_on_homepage_desktop = db.Column(db.Boolean, default=False)
    homepage_desktop_position = db.Column(db.Integer, nullable=True)
    show_on_homepage_mobile = db.Column(db.Boolean, default=False)
    homepage_mobile_position = db.Column(db.Integer, nullable=True)
